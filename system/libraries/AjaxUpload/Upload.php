...
class Upload
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => 'uploads/movies/',//dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/',
            'upload_url' => $this->get_full_url().'/uploads/movies/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    public function post($print_response = true) {
        ...
        $files = array();
        if ($upload) {
			$upload['name'] = md5(rand(1111111111, 9999999999)).".".pathinfo($upload['name'], PATHINFO_EXTENSION);//.Upload::ext($upload['name']);
