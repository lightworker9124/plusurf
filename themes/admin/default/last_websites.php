<?php include("header.php"); ?>
	<div id="admin-body" >
		<div id="header-title"> 
			...
			<a href="<?php _router("admin_last_websites"); ?>" data-original-title="Websites" class="tip-bottom"><i class="fa fa-globe"></i> Last Websites</a>
		</div>
		<div id="admin-content" >
		<div class="row" >
		<div class="col-md-12 main panel panel-default">
		<div class="panel-body" >
			<h1 class="page-header"><i class="fa fa-globe" ></i> Websites need confirmation</h1>
				...
				<table class="table table-striped">
				  ...
				  <tbody>
					...
					<tr id="item_<?php echo $one["id"]; ?>" >
					  ...
					  <td>
						<div class="btn-group">
						  <a id="act_<?php echo $one["id"]; ?>" href="Javascript::void(0)" onclick="activate(<?php echo $one["id"]; ?>, 'websites', 'act_<?php echo $one["id"]; ?>');" type="button" class="btn btn-success"><i class="fa fa-check" ></i>Confirm</a>
