			...
			<section  class="wrapper style5">
				<div class="content container">
                    ...
                    <?php _s("ads/header"); ?>
							...
							<div id="resend_alert"></div>
							<form id="resend_form" method="post" action="<?php _router("resend"); ?>">
								<div class="row uniform">
									<div class="12u 12u(xsmall)"><input type="text" name="resend_email" placeholder="<?php _l("email"); ?>" required="required" /></div>
