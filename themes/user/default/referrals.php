		...
		<div id="site-wrapper" >
			...
			<section  class="main style3 secondary">
				<div class="content container">
					...
					<hr>
					<div>
					<a class="btn btn-default" href="<?php _router("affiliate"); ?>" ><?php _l("edit_payment_info"); ?></a>
					<a class="btn btn-default" title="Min <?php _s("defaults/min_for_withdrawal"); ?>$" href="<?php if($info["confirmed_sold"] >= s("defaults/min_for_withdrawal") && s("defaults/min_for_withdrawal")){ _router("withdrawal"); } else { echo "#";} ?>" ><?php _l("ask_for_withdrawal"); ?></a>
					<?php if(u("points") >= 100) { ?> 
					<a href="Javascript::void(0);" class="btn btn-default" onclick="document.getElementById('converttosold').submit();" >Convert <?php echo floor(u("points")); ?> point to <?php echo floor((u("points")/100)*(s("exchange/pointcost"))); ?> $</a>
