			  ...
			  <div class="modal-dialog">
				<div class="modal-content">
				  ...
				  <div class="modal-body uniform">
						...
						<hr>
						<div class="form-group">
							<label class="control-label" for="inputDefault"><?php _l("visit_duration"); ?></label>
							<input type="text" id="seconds_range" name="website_seconds" value="" />
						</div>
						<div class="form-group">
							<div class="row" >
								<div class="5u" ><center><b id="calcul_points" ></b> <?php _l("point"); ?></center></div>
								<div class="2u" ><center><i class="icon fa-exchange"></i></center></div>
								<div class="5u" ><center><b id="calcul_visitors"></b> <?php _l("visitor"); ?></center></div>
							</div>
						</div>
						<hr>
						<div class="form-group">
					...
					<div class="row">
						<div class="12u">
							<ul class="actions">
								...
								<li><a href="Javascript::void(0)" class="btn btn-info" ><h2><?php _get("websites_count"); ?> / <?php _u("website_slots"); ?></h2></a></li>
							</ul>
						</div>
					</div>
						...
						<table class="table table-striped">
						  ...
						  ?>
							<tr id="website_<?php echo $website["id"]; ?>" >
							  ...
							  <td>
							  <a class="btn btn-info no-desktop on-phone on-tablet" target="_blank" href="<?php echo $website["url"]; ?>" ><i class="icon fa-share" ></i></a>
							  <a class="on-desktop no-phone no-tablet" target="_blank" href="<?php echo $website["url"]; ?>" ><?php echo Sys::split($website["url"], 20); ?></a>
							  </td>
